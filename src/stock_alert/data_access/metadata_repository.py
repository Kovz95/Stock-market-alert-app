...
def fetch_alerts() -> Dict[str, Dict[str, Any]]:
    """Fetch all alerts as a dictionary keyed by alert_id."""
    alerts_list = list_alerts()
    return {alert["alert_id"]: alert for alert in alerts_list}
