...
Usage:
    python scripts/analysis/verify_mexico_config.py

This script checks that the Mexico Stock Exchange (BMV) is properly
configured in the hourly data scheduler with the correct hours and
candle type.
"""
import sys
import os
...
from src.services.hourly_data_scheduler import get_exchange_market_hours
