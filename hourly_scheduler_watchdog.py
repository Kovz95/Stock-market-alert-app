"""
Shim loader for hourly_scheduler_watchdog.
...
_LEGACY_BYTECODE = Path(__file__).parent / "__pycache__/hourly_scheduler_watchdog_legacy.cpython-311.pyc"
_PYC_HEADER_SIZE = 16
_BOOTSTRAPPED = False
...
def _load_legacy_code() -> CodeType:
    if not _LEGACY_BYTECODE.exists():
        raise FileNotFoundError(
            f"Missing legacy bytecode for hourly_scheduler_watchdog at {_LEGACY_BYTECODE}."
        )
