...
def get_performance_profile(profile_name='production'):
    """
    Get performance settings for a specific profile
    """
    return PERFORMANCE_PROFILES.get(profile_name, PERFORMANCE_PROFILES['production'])

def update_performance_settings(settings_dict):
    """
    ...
    print(f"🔧 Updated performance settings: {settings_dict}")

def get_optimal_settings(alert_count):
    """
