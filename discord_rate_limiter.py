"""
Shim loader for discord_rate_limiter.
...
_LEGACY_BYTECODE = Path(__file__).parent / "__pycache__/discord_rate_limiter_legacy.cpython-311.pyc"
_PYC_HEADER_SIZE = 16
_BOOTSTRAPPED = False
...
def _load_legacy_code() -> CodeType:
    if not _LEGACY_BYTECODE.exists():
        raise FileNotFoundError(
            f"Missing legacy bytecode for discord_rate_limiter at {_LEGACY_BYTECODE}."
        )
